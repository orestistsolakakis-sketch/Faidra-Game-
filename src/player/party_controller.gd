extends Node3D
## Drives the party: owns the third-person camera rig, decides which character is
## active, switches between them, and handles mouse-look. Plain and reliable —
## cinematic camera work is deferred to the end of development. Mouse-look and
## switching are gated by active play in Exploration mode, so control frees during
## dialogue and pauses.
